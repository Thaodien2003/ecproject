...
public class AdminOrderController {
    ...
    public String orderUpdate(RedirectAttributes model,@ModelAttribute("entity") Order order,@RequestParam("orderTotal") String amount) throws ParseException{
        User user= (User) session.getAttribute("user");
        if(user ==null || !user.getAdmin()){
            return "redirect:/admin/login" ;
        }
        ...
        model.addFlashAttribute("message","Update Order Successful");
    ...
    public String removeOrder(@PathVariable("id") Integer id, RedirectAttributes model){
        User user= (User) session.getAttribute("user");
        if(user ==null || !user.getAdmin()){
            return "redirect:/admin/login" ;
        }
