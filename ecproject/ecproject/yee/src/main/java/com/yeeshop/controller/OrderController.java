...
public class OrderController {
	...
	public String checkOut(Model model,RedirectAttributes rModel,
		...
		for(Product product:list) {
			...
			qty=product2.getQuantity()-product.getQuantity();
			System.out.println("soluong:"+qty);
			if(qty>=0){
		...
		if(qty<0){
			rModel.addFlashAttribute("message","This product is not enough");
			...
			cartService.clear();
			rModel.addFlashAttribute("message","Order Successfully");
		}
